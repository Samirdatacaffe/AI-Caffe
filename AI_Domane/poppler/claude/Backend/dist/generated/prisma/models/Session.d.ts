...
export type SessionOmit<ExtArgs extends runtime.Types.Extensions.InternalArgs = runtime.Types.Extensions.DefaultArgs> = runtime.Types.Extensions.GetOmit<"id" | "userId" | "refreshTokenHash" | "expiresAt" | "device" | "ipAddress" | "location" | "lastActiveAt" | "createdAt", ExtArgs["result"]["session"]>;
